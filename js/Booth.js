var Booth = function (game) {
  ...
  /* var mirrorFloorMaterial = new BABYLON.PBRMaterial("floorGlassMaterial", this.getScene());
  mirrorFloorMaterial.albedoTexture = game.assets["earchairTex"].texture;
  mirrorFloorMaterial.albedoTexture.uScale = 1.0;
  mirrorFloorMaterial.albedoTexture.vScale = 1.0;
  mirrorFloorMaterial.metallic = 1.0;
  mirrorFloorMaterial.roughness = 1.0;
  mirrorFloorMaterial.metallicTexture = game.assets["sampleGeometryTex"].texture;
  mirrorFloorMaterial.useRoughnessFromMetallicTextureAlpha = false;
  mirrorFloorMaterial.useRoughnessFromMetallicTextureGreen = true;
  mirrorFloorMaterial.useMetallnessFromMetallicTextureBlue = true; */
