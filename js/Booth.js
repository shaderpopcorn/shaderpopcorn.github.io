var Booth = function (game) {
  ...
  //sl5.includedOnlyMeshes.push(wallsCeilingUF);
  ...
  //sl3.includedOnlyMeshes.push(tableSquare);
  ...
  /* const shadowGeneratorSL3 = new BABYLON.ShadowGenerator(1024, sl3);
  shadowGeneratorSL3.addShadowCaster(sofas, true);
  shadowGeneratorSL3.addShadowCaster(tableSquare, true);
  floorUF.receiveShadows = true;
  shadowGeneratorSL3.useBlurExponentialShadowMap = true;
  //shadowGeneratorSL1.useBlurCloseExponentialShadowMap = true;
  shadowGeneratorSL3.useKernelBlur = true;
  shadowGeneratorSL3.blurKernel = 10;
  shadowGeneratorSL3.blurScale = 4; */
